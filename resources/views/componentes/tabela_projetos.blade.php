...
<table class="table">
    ...
    @foreach($dados as $dado)
        <tr>
            @include('componentes.dados_projetos',['dado' => $dado])
            <td>
                <div class="ordena">
                    <ul>
                        ...
                        <li>
                            @if(!empty($rota_exibicao_projetos))
                                @include('componentes.link',['id' => $dado->id, 'rota' => $rota_exibicao_projetos,'nomebotao' => 'Visualizar Projetos'])
                            @elseif(!empty($rota_exibicao_modelos))
                                @include('componentes.link',['id' => $dado->id, 'rota' => $rota_exibicao_modelos,'nomebotao' => 'Visualizar Modelos'])
                            @endif
                        </li>
                    </ul>
